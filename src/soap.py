"""SOAP optimizer — vendored verbatim from https://github.com/nikhilvyas/SOAP (Apache-2.0).

Reference:
    Vyas et al. (2024) "SOAP: Improving and stabilizing Shampoo using Adam".
    arXiv:2409.11321.

This file is a copy of `soap.py` from the upstream repository. It is vendored
because the upstream is not pip-installable from PyPI as of 2026-05-07.
The Apache-2.0 license is retained; do not modify the algorithmic logic
without recording the deviation in `llmdocs/trackers/taylor_green_phase3_*.md`.

Used by `src/taylor_green_benchmark.py` when `--optimizer=soap`.
"""
import torch
